...
const Microsite = ({ microsites }: { microsites: Array<MicrositeAttributes> | undefined }) => {
                    ...
                    <div className='w-full flex flex-col bg-black/50' key={microsite.id}>
                        <div className='w-full grid grid-rows-4 xl:grid-cols-2 grid-cols-1 gap-3 p-5'>
                            ...
                            <div className="w-full flex gap-2">
                                <Link href={`http://localhost:3005/${microsite.domain}`} className='flex flex-1 py-2 bg-[#302e2b] hover:bg-black rounded-lg items-center justify-center'>View</Link>
                        ...
                        {microsite.leads && microsite.leads?.length > 0 &&
                            <div className='font-bold px-5  w-full text-xl flex flex-col items-center justify-center py-3 gap-5'>
                                <div>Leads</div>
